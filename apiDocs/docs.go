...
func InitializeOpenAPIReflector() *OpenAPIDocs {
	// OpenAPI generation
	description := "Kengine Runtime API provides programmatic control over Kengine microservice securing your container, kubernetes and cloud deployments. The API abstracts away underlying infrastructure details like cloud provider, \ncontainer distros, container orchestrator and type of deployment. This is one uniform API to manage and control security alerts, policies and response to alerts for microservices running anywhere i.e. managed pure greenfield container deployments or a mix of containers, VMs and serverless paradigms like AWS Fargate."
	tos := "/tos"
	contactName := "Kengine Support"
	contactURL := "https://kengine.io"
	contactEmail := "community@kengine.io"
	licenseURL := "https://www.apache.org/licenses/LICENSE-2.0"
	externalDocsDesc := "Kengine Community"

	reflector := &openapi3.Reflector{
		Spec: &openapi3.Spec{
			Openapi: "3.0.3",
			Info: openapi3.Info{
				Title:          "Kengine KhulnaSoft",
			...
			ExternalDocs: &openapi3.ExternalDocumentation{
				...
				URL:         "https://community.kengine.io",
			},
			Security: nil,
