...
func (h *Handler) RegisterUser(w http.ResponseWriter, r *http.Request) {
	...
	consoleURLSetting := model.Setting{
		...
		Value: &model.SettingValue{
			Label:       "Kengine Console URL",
			Value:       consoleURL,
			Description: "Kengine Console URL used for sending emails with links to the console",
		},
		IsVisibleOnUI: true,
	}
...
func (h *Handler) UpdateUserPassword(w http.ResponseWriter, r *http.Request) {
	...
	if user.Email == constants.KengineCommunityEmailID {
...
func (h *Handler) ResetPasswordRequest(w http.ResponseWriter, r *http.Request) {
	...
	if resetPasswordRequest.Email == constants.KengineCommunityEmailID {
